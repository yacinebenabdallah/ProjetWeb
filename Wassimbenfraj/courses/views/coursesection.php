...
$reponse4=$manager->afficher_section($_GET['id']) ;
...
?>
                                ...
                                <li class="accordion__item open">
                                    <a class="accordion__toggle" data-toggle="collapse" data-parent="#course-toc" href="#course-toc-<?=$i?>">
                                        <span class="flex"><?=$data4['section_name'] ?></span>
                                        <span class="accordion__toggle-icon material-icons">keyboard_arrow_down</span>
                                    </a>
                                    <div class="accordion__menu">
                                        <ul class="list-unstyled collapse" id="course-toc-<?=$i?>">
                                        <?php 
