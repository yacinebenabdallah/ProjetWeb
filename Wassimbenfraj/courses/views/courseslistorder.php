...
$reponse=$manager->filter($_POST['type']) ;
...
?>
                ...
                <div  class="col-md-4 col-sm-6 col-xs-12" style="height:549px;transition:4s;display:none;" >
                ...
                <div  class="col-md-444"   >
                    <div class="single-course mb-70" style="display: flex; margin-bottom: 20px; margin-left: 300px;">

                        <div class="course-img">

                            <a href="course-details.php?id=<?=$data['id'] ?>"><img src="img/course/course<?=$data['img'] ?>.jpg" alt="course">
                                <div class="course-hover">
