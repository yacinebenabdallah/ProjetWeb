...
<body>
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="cart-link1"><a href="CartMedone.php"><i aria-hidden="true"
                                                    class="fa fa-shopping-basket"></i> View Cart</a>
                                    </ul>
                                </nav>
                            </div>
                            <!--Search Form Start-->
    ...
    <div class="banner-area-wrapper">
        <div class="banner-area text-center" style="background-image: url(img/banner/Courses-01.png)">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
    ...
    <div class="course-area pt-150 pb-150">
        <div class="container">
            ...
            <div class="row">
                  <?php require 'php/courses/views/courseslist.php'; ?> <!--          affichage des courses  -->
            </div>    
        </div>
    </div>
    <!-- Course End -->
    ...
    <footer class="footer-area">
        ...
        <div class="footer-bottom text-center">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <p>Copyright © <a href="https://freethemescloud.com/" target="_blank">Free themes Cloud</a>
                            2017. All Right Reserved By Free themes Cloud.</p>
                    </div>
                </div>
            </div>
        </div>
