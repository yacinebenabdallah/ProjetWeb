                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="event-details">
                            ...
                            <?php require 'php/event/views/event-detail.php'; ?>    
                            
                            <div class="reply-area">
                                <h3>Subscribe to the event</h3>
                                <p>If you subscribe to the event we can make sure that a seat is left for you at our gathering. An email will be sent to you containing all the details. </p>

                                
                                <form id="contact-form" action="mail.php?id=<?=$data['id']?>" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>Name</p>
                                        ...
                                        <div class="col-md-12">
                                            <p>Phone Number</p>
                                            <input type="Number" name="number" placeholder="+216 ..">
                                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="blog-sidebar right">
                            ...
                            <div class="single-blog-widget mb-50">
                                <h3>categories</h3>
                                <ul>
                                    <li><a href="event.php?recherche=Design">Design</a></li>
                                    <li><a href="event.php?recherche=Web">Web</a></li>
                                    <li><a href="event.php?recherche=Branding">Branding</a></li>
                                    <li><a href="event.php?recherche=CSS">HTML5 &amp; CSS3 </a></li>
                                    <li><a href="event.php?recherche=Web Design">Web Design</a></li>
                                </ul>
                            </div>
                            <div class="single-blog-widget mb-50">
                                <div class="single-blog-banner">
                                    <a href="blog-details.php" id="blog"><img src="img/blog/blog-img.jpg" alt="blog"></a>
                            ...
                            <div class="single-blog-widget mb-50">
                                ...
                                <div class="single-post mb-30">
                                    <div class="single-post-img">
                                        <a href="event-details.php"><img src="img/post/post1.jpg" alt="post">
                                    ...
                                    <div class="single-post-content">
                                        <h4><a href="event-details.php">English Language Course for you</a></h4>
                                        <p>By Alex  /  June 20, 2017</p>
                                    </div>
                                </div>
                                <div class="single-post mb-30">
                                    <div class="single-post-img">
                                        <a href="blog-details.php"><img src="img/post/post2.jpg" alt="post">
                                            <div class="blog-hover">
                                                <i class="fa fa-link"></i>
                                            </div>
                                        </a>
                                    ...
                                    <div class="single-post-content">
                                        <h4><a href="blog-details.php">Advance Web Design and Develop</a></h4>
                                        <p>By Alex  /  June 20, 2017</p>
                                    </div>
                                </div>
                                <div class="single-post">
                                    <div class="single-post-img">
                                        <a href="blog-details.php"><img src="img/post/post3.jpg" alt="post">
                                            <div class="blog-hover">
                                                <i class="fa fa-link"></i>
                                            </div>
                                        </a>
                                    ...
                                    <div class="single-post-content">
                                        <h4><a href="blog-details.php">English Language Course for you</a></h4>
                                        <p>By Alex  /  June 20, 2017</p>
                                    </div>
                                </div>
                            </div>
                            <div class="single-blog-widget">
                                ...
                                <div class="single-tag">
                                    <a href="event.php?recherche=course" class="mr-10 mb-10">course</a>
                                    <a href="event.php?recherche=Education" class="mr-10 mb-10">education</a>
                                    <a href="event.php?recherche=teachers" class="mb-10">teachers</a>
                                    <a href="event.php?recherche=learning" class="mr-10">learning</a>
                                    <a href="event.php?recherche=University" class="mr-10">university</a>
                                    <a href="event.php?recherche=Events">events</a>
                                </div>
                            </div>
                        </div>
                    </div>
