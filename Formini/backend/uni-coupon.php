...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : coupon</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="uni-coupon.php" >All coupon</a>
                                </li>
                                <li>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">coupon</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>ID</th><th>Type</th><th>Value</th>   <th>Validite</th>    <th>supprimer</th>  <th>modifier</th>            </tr>
                                            </thead>

                                            <tbody>
                                                <?php
                                                require "../php/coupon/views/affichercoupon.php";
                                                ?>
                                            </tbody>
                                        </table>
                                        <!-- ********************************************** -->
