...
if( (document.form1.id.value != "")&&(document.form1.type.value != "")&&(document.form1.value.value != "")&&(document.form1.validite.value != "") ) {
...
function error(id)
{
    alert(id+" is already in use by another coupon !");
...
?>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Add a coupon</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                <li>
                                    <a class="" href="uni-order.php" >Orders placed</a>
                                </li>
                                <li>
                                    <a class="" href="uni-coupon.php" >All coupon</a>
                                </li>
                                <li>
                                    <a class="active" href="uni-coupon-add.php" >Add coupon</a>
                                </li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Add a coupon</h1>                            </div>
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    ...
                                    <li>
                                        <a href="uni-coupon.php">coupon</a>
                                    </li>
                                    <li class="active">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <form onsubmit="return valider()" name="form1" action ="../php/coupon/views/ajoutcoupon.php" method="get">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input name="id" type="text" value="" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">value</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input name="value" type="text" value="" class="form-control" id="field-1">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label" for="field-5">Validite</label>
                                                <span class="desc"></span>
