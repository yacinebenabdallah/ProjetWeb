...
<html class="no-js" lang="en">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <div class="header-top-left">
                                <p>HAVE ANY QUESTION ?  +53 888 628</p>
                            </div>
                        </div>
		...
		<div class="banner-area-wrapper">
            <div class="banner-area text-center" style="background-image: url(img/about/OurTeam.png)">	
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="about-content">
                            <h2>WELCOME TO <span>EDUHOME,</span> The <span>leading global</span> marketplace for <span>learning</span> and <span>instruction</span></h2>
                            <p>By connecting students all over the world to the best instructors, Eduhome is helping individuals reach their goals and pursue their dreams.</p>
                            <p class="hidden-sm">EDUHOME helps organizations of all kinds prepare for the ever-evolving future of work. Our curated collection of top-rated business and technical courses gives companies, governments, and nonprofits the power to develop in-house expertise and satisfy employees’ hunger for learning and development.</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-teacher">
                            <div class="single-teacher-img">
                                <a href="teacher-details.php"><img src="img/teacher/teacher1.png" alt="teacher"></a>  
                            </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-teacher">
                            <div class="single-teacher-img">
                                <a href="teacher-details.php"><img src="img/teacher/teacher2.png" alt="teacher"></a>  
                            </div>
                            <div class="single-teacher-content text-center">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-teacher">
                            <div class="single-teacher-img">
                                <a href="teacher-details.php"><img src="img/teacher/teacher3.png" alt="teacher"></a>  
                            </div>
                            <div class="single-teacher-content text-center">
                    ...
                    <div class="col-md-3 hidden-sm col-xs-12">
                        <div class="single-teacher">
                            <div class="single-teacher-img">
                                <a href="teacher-details.php"><img src="img/teacher/teacher4.png" alt="teacher"></a>  
                            </div>
                            <div class="single-teacher-content text-center">
        ...
        <div class="testimonial-area pt-110 pb-105 text-center" style="background-image: url(img/testimonial/backgroundimg-01.png)">
            <div class="container">
                <div class="row">
                            ...
                            <div class="single-testimonial">
                                <div class="testimonial-info">
                                    <div class="testimonial-img">
                                        <img src="img/testimonial/testimonial.png" alt="testimonial">
                                    </div>
                                    <div class="testimonial-content">
                                        <p>Eduhome has given me the opportunity to reach a global audience for my classes that wouldn’t have been possible otherwise.</p>
                                        <h4>David Morgan</h4>
                                        <h5>Teacher, CSE</h5>
                                    </div>
                                </div>
                        ...
                        <div class="notice-right-wrapper mb-25 pb-25">
                            ...
                            <div class="notice-video">
                                <div class="video-icon video-hover">
                                    <a class="video-popup" href="https://www.youtube.com/watch?v=ZPs3URGs0KQ">
