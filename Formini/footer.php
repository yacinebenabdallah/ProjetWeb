        ...
        <footer class="footer-area">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="single-widget pr-60">
                                ...
                                <div class="footer-social">
                                    <ul>
                                        <li><a href="https://www.facebook.com/Forminii.tn/"><i class="zmdi zmdi-facebook"></i></a></li>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="single-widget">
                                <h3>get in touch</h3>
                                <p>14, Rue de Russie<br>Tunis, Tunisie</p>
                                <p>+216 53 888 628 <br>+216 57 135 688</p>
                                <p>FormiTN@gmail.tn<br>www.eduhome.com</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-bottom text-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <p>Copyright © <a href="#" target="_blank">Invisix Team</a> 2017. All Right Reserved By Invisix Team.</p>
                        </div> 
                    </div>
                </div>    
            </div>
